...
/**
 * An actor designed to process a single piece of work item, and then ask a [[biz.crawler.actor.Master]]
 ...
 * handled between this worker and [[biz.crawler.actor.Master]].
 *
 * @param master [[biz.crawler.actor.Master]] Actor that handles storing and orchestrating
